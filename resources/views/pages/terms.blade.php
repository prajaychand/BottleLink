            ...
            <div class="col-lg-10">
                            ...
                            <div class="col-md-6">
                                <ul class="list-unstyled">
                                    ...
                                    <li class="mb-2"><a href="#section3" class="text-decoration-none d-flex align-items-center text-white">
                                        <span class="badge rounded-pill me-2" style="background-color: #FFD700; color: #000;">2</span> Payment
                                    </a></li>
                                    <li class="mb-2"><a href="#section4" class="text-decoration-none d-flex align-items-center text-white">
                                        <span class="badge rounded-pill me-2" style="background-color: #FFD700; color: #000;">3</span> Returns and Refunds
                                    </a></li>
                                </ul>
                            </div>
                            <div class="col-md-6">
                                <ul class="list-unstyled">
                                    <li class="mb-2"><a href="#section5" class="text-decoration-none d-flex align-items-center text-white">
                                        <span class="badge rounded-pill me-2" style="background-color: #FFD700; color: #000;">4</span> User Responsibilities
                                    </a></li>
                                    <li class="mb-2"><a href="#section6" class="text-decoration-none d-flex align-items-center text-white">
                                        <span class="badge rounded-pill me-2" style="background-color: #FFD700; color: #000;">5</span> Privacy
                                    </a></li>
                                    <li class="mb-2"><a href="#section7" class="text-decoration-none d-flex align-items-center text-white">
                                        <span class="badge rounded-pill me-2" style="background-color: #FFD700; color: #000;">6</span> Changes to Terms
                                    </a></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="card border-0 shadow-lg" style="border-radius: 15px; overflow: hidden; background-color: #1E1E1E; border: 1px solid #333;">
                    <div class="card-body p-0">
                        ...
                        <!-- Section 2 -->
                        <div id="section2" class="p-5 position-relative" style="border-bottom: 1px solid rgba(255,255,255,0.1);">
                            <div class="position-absolute" style="width: 5px; height: 70%; background-color: #FFD700; left: 0; top: 15%; border-radius: 0 4px 4px 0;"></div>
                            <h3 class="fw-bold mb-4" style="color: #FFD700;">2. Payment</h3>
                            <p class="text-light mb-0" style="font-size: 1.05rem; line-height: 1.7; opacity: 0.9;">
                        ...
                        <!-- Section 3-->
                        <div id="section3" class="p-5 position-relative" style="border-bottom: 1px solid rgba(255,255,255,0.1); background-color: #252525;">
                            <div class="position-absolute" style="width: 5px; height: 70%; background-color: #FFD700; left: 0; top: 15%; border-radius: 0 4px 4px 0;"></div>
                            <h3 class="fw-bold mb-4" style="color: #FFD700;">3. Returns and Refunds</h3>
                            <p class="text-light mb-0" style="font-size: 1.05rem; line-height: 1.7; opacity: 0.9;">
                        ...
                        <!-- Section 4 -->
                        <div id="section4" class="p-5 position-relative" style="border-bottom: 1px solid rgba(255,255,255,0.1);">
                            <div class="position-absolute" style="width: 5px; height: 70%; background-color: #FFD700; left: 0; top: 15%; border-radius: 0 4px 4px 0;"></div>
                            <h3 class="fw-bold mb-4" style="color: #FFD700;">4. User Responsibilities</h3>
                            <p class="text-light mb-0" style="font-size: 1.05rem; line-height: 1.7; opacity: 0.9;">
                        ...
                        <!-- Section 5 -->
                        <div id="section5" class="p-5 position-relative" style="border-bottom: 1px solid rgba(255,255,255,0.1); background-color: #252525;">
                            <div class="position-absolute" style="width: 5px; height: 70%; background-color: #FFD700; left: 0; top: 15%; border-radius: 0 4px 4px 0;"></div>
                            <h3 class="fw-bold mb-4" style="color: #FFD700;">5. Privacy</h3>
                            <p class="text-light mb-0" style="font-size: 1.05rem; line-height: 1.7; opacity: 0.9;">
                        ...
                        <div id="section6" class="p-5 position-relative">
                            <div class="position-absolute" style="width: 5px; height: 70%; background-color: #FFD700; left: 0; top: 15%; border-radius: 0 4px 4px 0;"></div>
                            <h3 class="fw-bold mb-4" style="color: #FFD700;">6. Changes to Terms</h3>
                            <p class="text-light mb-0" style="font-size: 1.05rem; line-height: 1.7; opacity: 0.9;">
